...
export function generateSingleEliminationBracket(players) {
  const num = players.length;
  if (num < 4 || num > 8) throw new Error("Single Elimination is supported for 4 to 8 players.");
  ...
  if (num === 4) {
    matches = [
      { key: 'm1', round: 'SF', homeId: s(0), awayId: s(3), label: 'Semifinal 1' },
      { key: 'm2', round: 'SF', homeId: s(1), awayId: s(2), label: 'Semifinal 2' },
      { key: 'm3', round: 'GF', homeId: null, awayId: null, label: 'Grand Final', dependsOn: { home: { match: 'm1', type: 'winner' }, away: { match: 'm2', type: 'winner' } } }
    ];
  } else if (num === 5) {
    matches = [
      { key: 'm1', round: 'QF', homeId: s(3), awayId: s(4), label: 'Quarterfinal 1' },
      { key: 'm2', round: 'SF', homeId: s(0), awayId: null, label: 'Semifinal 1', dependsOn: { away: { match: 'm1', type: 'winner' } } },
      { key: 'm3', round: 'SF', homeId: s(1), awayId: s(2), label: 'Semifinal 2' },
      { key: 'm4', round: 'GF', homeId: null, awayId: null, label: 'Grand Final', dependsOn: { home: { match: 'm2', type: 'winner' }, away: { match: 'm3', type: 'winner' } } }
    ];
  } else if (num === 6) {
    matches = [
      { key: 'm1', round: 'QF', homeId: s(3), awayId: s(4), label: 'Quarterfinal 1' },
      { key: 'm2', round: 'QF', homeId: s(2), awayId: s(5), label: 'Quarterfinal 2' },
      { key: 'm3', round: 'SF', homeId: s(0), awayId: null, label: 'Semifinal 1', dependsOn: { away: { match: 'm1', type: 'winner' } } },
      { key: 'm4', round: 'SF', homeId: s(1), awayId: null, label: 'Semifinal 2', dependsOn: { away: { match: 'm2', type: 'winner' } } },
      { key: 'm5', round: 'GF', homeId: null, awayId: null, label: 'Grand Final', dependsOn: { home: { match: 'm3', type: 'winner' }, away: { match: 'm4', type: 'winner' } } }
    ];
  } else if (num === 7) {
    matches = [
      { key: 'm1', round: 'QF', homeId: s(3), awayId: s(4), label: 'Quarterfinal 1' },
      { key: 'm2', round: 'QF', homeId: s(2), awayId: s(5), label: 'Quarterfinal 2' },
      { key: 'm3', round: 'QF', homeId: s(1), awayId: s(6), label: 'Quarterfinal 3' },
      { key: 'm4', round: 'SF', homeId: s(0), awayId: null, label: 'Semifinal 1', dependsOn: { away: { match: 'm1', type: 'winner' } } },
      { key: 'm5', round: 'SF', homeId: null, awayId: null, label: 'Semifinal 2', dependsOn: { home: { match: 'm2', type: 'winner' }, away: { match: 'm3', type: 'winner' } } },
      { key: 'm6', round: 'GF', homeId: null, awayId: null, label: 'Grand Final', dependsOn: { home: { match: 'm4', type: 'winner' }, away: { match: 'm5', type: 'winner' } } }
    ];
  } else if (num === 8) {
    matches = [
      { key: 'm1', round: 'QF', homeId: s(0), awayId: s(7), label: 'Quarterfinal 1' },
      { key: 'm2', round: 'QF', homeId: s(3), awayId: s(4), label: 'Quarterfinal 2' },
      { key: 'm3', round: 'QF', homeId: s(1), awayId: s(6), label: 'Quarterfinal 3' },
      { key: 'm4', round: 'QF', homeId: s(2), awayId: s(5), label: 'Quarterfinal 4' },
      { key: 'm5', round: 'SF', homeId: null, awayId: null, label: 'Semifinal 1', dependsOn: { home: { match: 'm1', type: 'winner' }, away: { match: 'm2', type: 'winner' } } },
      { key: 'm6', round: 'SF', homeId: null, awayId: null, label: 'Semifinal 2', dependsOn: { home: { match: 'm3', type: 'winner' }, away: { match: 'm4', type: 'winner' } } },
      { key: 'm7', round: 'GF', homeId: null, awayId: null, label: 'Grand Final', dependsOn: { home: { match: 'm5', type: 'winner' }, away: { match: 'm6', type: 'winner' } } }
    ];
  }
